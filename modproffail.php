	...
	<body>
      ...
      <table width="80%" align="center" class="fboard" cellpadding="5" cellspacing="5">
        <tr align="center">
          ...
          <td width="33%" style="background-color: #0600B3;">
				...
				<tr>
					...
					<td width="75%" align="center">
						<table width="100%" class="dboard" cellpadding="5" cellspacing="5" align="center">
							<tr>
								...
								<td width="25%">
												 ...
												 <input type="image" name="zero" src="reset.png" value="submit" width="50%"><input type="hidden" name="zero" value="zero">
						...
						<table width="80%" align="center" cellpadding="10" cellspacing="10">
							...
							<table width="100%" class="dboard" cellpadding="5" cellspacing="5" align="center">
									<tr>
										<td align="center" colspan="2"><span class="t1">Modifier les informations d'un professeur :</span><br><br><span class="fail">Le SOM que vous avez entrez n'appartient a aucun professeur .</span></td>
									</tr>
									<tr>
